...
class _kategori_pengeluaranState extends State<kategori_pengeluaran> {
  ...
  KategoriPengeluaranService _kategoriPengeluaranService = KategoriPengeluaranService();
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(kategoriPengeluaran['namaKategoriOut']),
                  subtitle: Text(kategoriPengeluaran['fotoKategoriOut']),
                  leading: Container(
